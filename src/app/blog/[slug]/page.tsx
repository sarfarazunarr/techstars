...
const SingleBlog = async ({ params }: { params: { slug: string } }) => {
    ...
    return (
        <>
            {typeof data !== "string" && <div className='w-full px-4 md:px-40 py-10 flex flex-col justify-center items-center gap-y-10'>
                <div className='p-3 flex flex-col gap-y-4'>
                    <span className='px-2 rounded-md bg-asmani text-white max-w-min p-1'>{data.category.name}</span>
